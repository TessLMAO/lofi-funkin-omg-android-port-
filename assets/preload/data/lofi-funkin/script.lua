function onCreate()
  ...
  addLuaSprite('LOFIEnding', false);

  precacheImage('LOFIEnding')
end

function onStepHit()
	if curStep == 7697 then
      makeAnimatedLuaSprite('LOFIEnding', 'LOFIEnding', -900, -640)
      addAnimationByIndices('LOFIEnding', 'idle', 'Idle',false,7)
      setLuaSpriteScrollFactor('LOFIEnding', 0.1, 0.1);
      scaleObject('LOFIEnding', 5, 5);
      setProperty('LOFIEnding.antialiasing', false);
      addLuaSprite('LOFIEnding', true);
   end
end
